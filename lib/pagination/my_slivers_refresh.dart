...
class MySliverRefresh extends SingleChildRenderObjectWidget {
  const MySliverRefresh({
    super.key,
    this.paintOffsetY,
  ...
  /// _MyRenderSliverRefresh will paint the child in the available
  /// space either way but this instructs the _MyRenderSliverRefresh
  ...
  @override
  MyRenderSliverRefresh createRenderObject(BuildContext context) {
    return MyRenderSliverRefresh(
  ...
  void updateRenderObject(
      BuildContext context, covariant MyRenderSliverRefresh renderObject) {
    final RefreshStatus mode =
        MyRefresher.of(context)!.controller.headerMode!.value;
    renderObject
...
class MyRenderSliverRefresh extends RenderSliverSingleBoxAdapter {
  MyRenderSliverRefresh(
...
class MySliverLoading extends SingleChildRenderObjectWidget {
  ...
  @override
  MyRenderSliverLoading createRenderObject(BuildContext context) {
    return MyRenderSliverLoading(
  ...
  @override
  void updateRenderObject(
      BuildContext context, covariant MyRenderSliverLoading renderObject) {
    renderObject
      ..mode = mode
      ..hasLayoutExtent = floating!
      ..layoutExtent = layoutExtent
...
class MyRenderSliverLoading extends RenderSliverSingleBoxAdapter {
  MyRenderSliverLoading({
    RenderBox? child,
    this.mode,
    double? layoutExtent,
  ...
  bool _computeIfFull(SliverConstraints cons) {
    ...
    while (sliverP != this) {
      if (sliverP is MyRenderSliverRefresh) {
...
class MySliverRefreshBody extends SingleChildRenderObjectWidget {
  /// Creates a sliver that contains a single box widget.
  const MySliverRefreshBody({
    super.key,
    super.child,
  });

  @override
  MyRenderSliverRefreshBody createRenderObject(BuildContext context) =>
      MyRenderSliverRefreshBody();
}

class MyRenderSliverRefreshBody extends RenderSliverSingleBoxAdapter {
