...
/// add [MyRefreshLocalizations.delegates] to
/// [MaterialApp.localizationsDelegates], and specify the locales your
/// app supports with [MaterialApp.supportedLocales]:
///
/// ```dart
/// new MaterialApp(
///   localizationsDelegates: MyRefreshLocalizations.delegates,
///   supportedLocales: [
...
///
/// ```
class MyRefreshLocalizations {
  final Locale locale;

  MyRefreshLocalizations(this.locale);
  ...
  static const MyRefreshLocalizationsDelegate delegate =
      MyRefreshLocalizationsDelegate();

  static MyRefreshLocalizations? of(BuildContext context) {
    return Localizations.of(context, MyRefreshLocalizations);
  }
}

class MyRefreshLocalizationsDelegate
    extends LocalizationsDelegate<MyRefreshLocalizations> {
  const MyRefreshLocalizationsDelegate();
  ...
  @override
  Future<MyRefreshLocalizations> load(Locale locale) {
    return SynchronousFuture<MyRefreshLocalizations>(
        MyRefreshLocalizations(locale));
  }

  @override
  bool shouldReload(LocalizationsDelegate<MyRefreshLocalizations> old) {
    return false;
  }
}
